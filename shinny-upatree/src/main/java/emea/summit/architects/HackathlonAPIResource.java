...
//		put("alabaster-snowball", "ALABASTER_SNOWBALL");
	...
	@ApiOperation("shinny-upatree, Tests printing the forwarded payload - Normally it would sort it and pass it on")
	public String test(TeamPayload request) {

		System.out.println("Calling  SHINNY-UPATREE-TST successfully");
		System.out.println("Received Content -->"+request);

		System.out.println("REINDEER 1 [System.getenv(\"TEAM_B_REINDEER_1\")]: "+System.getenv("TEAM_B_REINDEER_1"));
		System.out.println("REINDEER 2 [System.getenv(\"TEAM_B_REINDEER_2\")]: "+System.getenv("TEAM_B_REINDEER_2"));		
		
		HashMap<String, String> emailMap = new HashMap<String, String>(){{put("shinny-upatree-Helper1", "suh1@santavillage.com");}};
		RequestPayload newPayload1 = new RequestPayload("santas-helpers-b-team", System.getenv("TEAM_B_REINDEER_1"), emailMap);
		request.getPayload().add(newPayload1);
		
		RequestPayload newPayload2 = new RequestPayload("santas-helpers-b-team", System.getenv("TEAM_B_REINDEER_2"), emailMap);
		request.getPayload().add(newPayload2);
		
		request.setServiceName("shinny-upatree");
		...
		return "Calling  SHINNY-UPATREE-TST successfully";
	}
